  ...
  return (
    <div className='relative flex w-full h-full items-center justify-center'>
      <div className={`relative ${itemAddState || itemRepState || itemSupState ? 'hidden opacity-0' : 'flex opacity-100'} w-full h-full items-center justify-center gap-12 transition-all`}>
        <button onClick={() => { setItemRepState(true); setItemAddState(false); setItemSupState(false) }} className='relative flex w-fit h-fit text-zinc-600 gap-2 rounded border border-zinc-800 py-1.5 px-2.5 items-center justify-center shadow shadow-zinc-950 hover:shadow-lg hover:shadow-zinc-950 active:scale-95 transition-all'>
        ...
        <button onClick={() => { setItemRepState(false); setItemAddState(false); setItemSupState(true) }} className='relative flex w-fit h-fit text-zinc-600 gap-2 rounded border border-zinc-800 py-1.5 px-2.5 items-center justify-center shadow shadow-zinc-950 hover:shadow-lg hover:shadow-zinc-950 active:scale-95 transition-all'>
        ...
        <button onClick={() => { setItemRepState(false); setItemAddState(true); setItemSupState(false) }} className='relative flex w-fit h-fit text-zinc-600 gap-2 rounded border border-zinc-800 py-1.5 px-2.5 items-center justify-center shadow shadow-zinc-950 hover:shadow-lg hover:shadow-zinc-950 active:scale-95 transition-all'>
